#!/usr/bin/env bash
#SBATCH --job-name=gate6-modern-xenofilx-fixed
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/gate6-modern-xenofilx-fixed-%j.log
set -euo pipefail
...
evidence_directory="${evidence_root}/modern-xenofilx-fixed-strand-aware-${SLURM_JOB_ID}"
...

{
    ...
    printf 'bisulfite=true\n'
    printf 'output_provenance=directly_generated_from_ndcwfa_original_bams\n'
    printf 'nm_semantics=strand_aware_bisulfite\n'
...

{
    ...
    printf 'modern_filtered_bam_sha256\t'
