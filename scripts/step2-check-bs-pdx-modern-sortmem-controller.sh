#!/usr/bin/env bash
#SBATCH --job-name=otter-bs-pdx-modern-step2-check
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/step2-check-bs-pdx-modern-sortmem-controller.log
set -uo pipefail
...
run_configuration="/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/projects/bs-pdx-SRR23802966/runs/run-20260821T002101Z-hycjez/run.yaml"

printf 'step2-check-start modern %s\n' "$(date -u +%FT%TZ)"
...
project_exit=$?
printf 'step2-check-exit modern %d %s\n' "${project_exit}" "$(date -u +%FT%TZ)"
exit "${project_exit}"
