#!/usr/bin/env bash
#SBATCH --job-name=otter-step1-bs-pdx-SRR36187610
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/step1-bs-pdx-SRR36187610-controller.log
set -euo pipefail
...
"${otter_bin}" run --foreground --config "${run_yaml}" --executor craftmake --phase step1 --craftmake-binary "${craftmake_bin}" --parallel-jobs 4
