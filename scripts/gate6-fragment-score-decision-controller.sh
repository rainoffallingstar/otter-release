...
legacy_directory="${evidence_root}/legacy-picard-xenofilter-41740193"
legacy_graft_input="${legacy_directory}/SRR36187610_hg38.picard-nm.bam"
legacy_host_input="${legacy_directory}/SRR36187610_mm10.picard-nm.bam"
...
"${samtools_binary}" view -N "${names_file}" "${legacy_graft_input}" > "${evidence_directory}/legacy-graft.sam"
"${samtools_binary}" view -N "${names_file}" "${legacy_host_input}" > "${evidence_directory}/legacy-host.sam"
