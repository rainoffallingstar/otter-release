#!/usr/bin/env bash
#SBATCH --job-name=gate6-membership-strand-aware-legacy
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/gate6-membership-strand-aware-legacy-%j.log
set -euo pipefail
...
evidence_directory="${evidence_root}/fragment-membership-strand-aware-legacy-${SLURM_JOB_ID}"
