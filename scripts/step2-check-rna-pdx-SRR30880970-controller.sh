#!/usr/bin/env bash
#SBATCH --job-name=otter-step2-check-rna-pdx-SRR30880970
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/step2-check-rna-pdx-SRR30880970-controller.log
set -euo pipefail
...
"${otter_bin}" run --foreground --config "${run_yaml}" --executor craftmake --phase step2-check --craftmake-binary "${craftmake_bin}" --parallel-jobs 4 --catalog "${CRAFTMAKE_WORKFLOW_CATALOG}"
