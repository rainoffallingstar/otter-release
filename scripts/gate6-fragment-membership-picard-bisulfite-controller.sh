#!/usr/bin/env bash
#SBATCH --job-name=gate6-membership-picard-bisulfite
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/gate6-membership-picard-bisulfite-%j.log
set -euo pipefail
...
evidence_directory="${evidence_root}/fragment-membership-picard-bisulfite-${SLURM_JOB_ID}"
...
legacy_filtered="${evidence_root}/legacy-picard-bisulfite-xenofilter-${legacy_job_id}/xenofilter-destination/Filtered_bams/SRR36187610_hg38.picard-bisulfite-nm_Filtered.bam"
...
mkdir "${evidence_directory}/temporary"
{
    ...
    printf 'legacy_nm_semantics=picard_bisulfite_aware\n'
