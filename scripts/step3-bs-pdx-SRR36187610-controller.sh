#!/usr/bin/env bash
#SBATCH --job-name=otter-step3-bs-pdx-SRR36187610
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/step3-bs-pdx-SRR36187610-controller.log
set -euo pipefail
