#!/usr/bin/env bash
#SBATCH --job-name=gate6-membership-provenance-rerun
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/gate6-membership-provenance-rerun-%j.log
set -euo pipefail
...
evidence_directory="${evidence_root}/fragment-membership-provenance-rerun-${SLURM_JOB_ID}"
...
comparison_script="${runtime_directory}/gate6-fragment-membership-compare-rerun-20260904.py"
...
legacy_filtered="${evidence_root}/legacy-picard-strand-aware-xenofilter-${legacy_job_id}/xenofilter-destination/Filtered_bams/SRR36187610_hg38.picard-strand-aware-nm_Filtered.bam"
...
mkdir "${evidence_directory}/temporary"
{
    ...
    printf 'provenance_path_policy=preserve_logical_input_path_without_symlink_resolution\n'
