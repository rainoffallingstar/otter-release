#!/usr/bin/env bash
#SBATCH --job-name=gate6-legacy-picard-bisulfite
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/gate6-legacy-picard-bisulfite-%j.log
set -euo pipefail
...
evidence_directory="${evidence_root}/legacy-picard-bisulfite-xenofilter-${SLURM_JOB_ID}"
...
graft_patched="${evidence_directory}/SRR36187610_hg38.picard-bisulfite-nm.bam"
host_patched="${evidence_directory}/SRR36187610_mm10.picard-bisulfite-nm.bam"
...
legacy_filtered_bam="${evidence_directory}/xenofilter-destination/Filtered_bams/SRR36187610_hg38.picard-bisulfite-nm_Filtered.bam"
