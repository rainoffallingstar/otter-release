#!/usr/bin/env bash
#SBATCH --job-name=gate6-fragment-membership
...
#SBATCH --output=/public3/home/scg9946/otter-gate6/toolchain-comparison-20260815T070000Z/runtime/gate6-fragment-membership-%j.log
set -euo pipefail
...
evidence_directory="${evidence_root}/fragment-membership-${SLURM_JOB_ID}"
...
modern_filtered="${evidence_root}/modern-xenofilx-ndcwfa-${modern_job_id}/output/SRR36187610_fixed_hg38_Filtered.bam"
